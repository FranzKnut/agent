...
"""Simple MNIST classifier to demonstrate features of Agent.
...
import tensorboard.plugins.agent as agent_lib

FLAGS = None

LOG_DIRECTORY = '/tmp/agent-demo'
...
def train():
  ...
  with tf.name_scope('train'):
    ...
    gradients, train_step = agent_lib.Agent.gradient_helper(
  ...
  agent = agent_lib.Agent(logdir=LOG_DIRECTORY)
